...
public class Smily_Helper_0_5_2_3_17_27_05_03_2021 extends PApplet {
   ...
   while(sumly<num+1){ 
     if(sumlx<=num)
     {
       ...
       stroke(0);
         ...
         if((mouseoverx>=0&&mouseoverx<=600)&&(mouseovery>=30&&mouseovery<=630)){
 if (mousePressed){    
               gety= (int)mouseovery; 
  getx=(int)mouseoverx ;  
...
*/
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Smily_Helper_0_5_2_3_17_27_05_03_2021" };
    if (passedArgs != null) {
