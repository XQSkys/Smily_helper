...
public class Smily_Helper_V_1_6_2 extends PApplet {
...
public void draw() {
  ...
  if ((mouseoverx>=0&&mouseoverx<=feld*(num1+1))&&(mouseovery>=30&&mouseovery<=feld*(num1+1)+30)) {
    if   (mousePressed && (mouseButton == RIGHT)) {
      gety= (int)mouseovery; 
      getx=(int)mouseoverx ;  
 ...
 //     println("y"+sumly);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Smily_Helper_V_1_6_2" };
    if (passedArgs != null) {
