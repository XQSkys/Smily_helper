...
fill(rc,0,0);
rect(sumlx*feld,sumly*feld+30,feld,feld);fill(rc,0,0);
rect(sumlx+600,sumly+30,1,1);
fill(0,gc,0);
rect(sumlx*feld,sumly*feld+30,feld,feld);fill(0,gc,0);
rect(sumlx+800,sumly+30,1,1);
fill(0,0,bc);
rect(sumlx*feld,sumly*feld+30,feld,feld);fill(0,0,bc);
rect(sumlx+600,sumly+230,1,1);
qc=(rc+gc+bc)/3;
fill(qc);
rect(sumlx*feld,sumly*feld+30,feld,feld);fill(qc);
