...
public class Smily_Helper_V_1_7_8_color_map extends PApplet {
...
outputbw = createWriter("listbw.txt"); 
...
outputbw.println(grayValue);
        ...
        xi++;
         ...
         outputr.println("eol"); outputg.println("eol");outputb.println("eol"); outputbw.println("eol");   if(yi>=ey){outputr.println("eof");  
        ij=1;
        if(yi==num){
...
//if (bild == null) { iv--; if (iv<0)iv=0;}
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Smily_Helper_V_1_7_8_color_map" };
    if (passedArgs != null) {
