...
public class Smily_Helper_V_1_7_5_give3 extends PApplet {
...
public void setup() {
  ...
  myServer02 = new Server(this, 5202);
    myServer03 = new Server(this, 5203);
      myServer04 = new Server(this, 5204);
        myServer05 = new Server(this, 5205);
  myServer06 = new Server(this, 5206);
  background(255);
...
if(mousePressed){
s2=1;
myServer04.write((int)mouseoverx);
myServer05.write((int)mouseovery);}
...
//if (bild == null) { iv--; if (iv<0)iv=0;}
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Smily_Helper_V_1_7_5_give3" };
    if (passedArgs != null) {
