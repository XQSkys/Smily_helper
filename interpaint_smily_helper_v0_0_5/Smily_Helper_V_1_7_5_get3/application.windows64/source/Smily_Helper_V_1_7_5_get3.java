...
public class Smily_Helper_V_1_7_5_get3 extends PApplet {
...
int ey=0;
public void setup() { 
    myClient01= new Client(this, "127.0.0.1", 5201); 
myClient02= new Client(this, "127.0.0.1", 5202);  
myClient03= new Client(this, "127.0.0.1", 5203);  
myClient04= new Client(this, "127.0.0.1", 5204);  
myClient05= new Client(this, "127.0.0.1", 5205);  
 myClient06= new Client(this, "127.0.0.1", 5206); 
...
public void draw() {
    ...
    if (myClient06.available() > 0) { 
      s2=myClient06.read();}
  
if(s2==1){
if (myClient01.available() > 0) { 
      rc=myClient01.read();}
      if (myClient02.available() > 0) { 
      gc=myClient02.read();}
     
      if (myClient03.available() > 0) { 
      bc=myClient03.read();}
      
      
      if (myClient04.available() > 0) { 
      mouseoverx=myClient04.read();}
  
      if (myClient05.available() > 0) { 
      mouseovery=myClient05.read();}}
...
if   (mousePressed){
  mouseovery = mouseY;
  mouseoverx = mouseX;
}else { if (myClient01.available() > 0) { 
      rc=myClient01.read();}
      if (myClient02.available() > 0) { 
      gc=myClient02.read();}
  ...
  if ((mouseoverx>=0&&mouseoverx<=feld*(num1+1)-1)&&(mouseovery>=30&&mouseovery<=feld*(num1+1)+30-1)||s2==1) {
    if   (mousePressed && (mouseButton == RIGHT)) {
      gety= (int)mouseovery; 
      getx=(int)mouseoverx ;  
    ...
    if   (mousePressed && (mouseButton == LEFT)||s2==1) {    
...
//if (bild == null) { iv--; if (iv<0)iv=0;}
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Smily_Helper_V_1_7_5_get3" };
    if (passedArgs != null) {
