...
public class Smily_Helpe2r_V_0_2_4_3 extends PApplet {
...
outputbr = createWriter("work/listr.txt"); 
outputbbw = createWriter("work/list.txt"); 
neu=1;  xi=0;yi=0;li=0;lx=0;ly=0; iv++;  
}
      fill(255);
      rect(200, 0, 90, 30);  
      fill(0);
...
li1=0;
 ...
 /*
     ...
     // String[] linesr = loadStrings("");
  

  
        if (iv>=1&&iv<=9)
           {  linesr = loadStrings("rWtxt"+ordner+"/rSavestxt/rMovie000000"+iv+".txt");}
        if (iv>=10&&iv<=99)
           {  linesr = loadStrings("rWtxt"+ordner+"/rSavestxt/rMovie00000"+iv+".txt");}
        if (iv>=100&&iv<=999)
       {  linesr = loadStrings("rWtxt"+ordner+"/rSavestxt/rMovie0000"+iv+".txt");}
        if (iv>=1000&&iv<=9999)
   {  linesr = loadStrings("rWtxt"+ordner+"/rSavestxt/rMovie000"+iv+".txt");}
        if (iv>=10000&&iv<=99999)
   {  linesr = loadStrings("rWtxt"+ordner+"/rSavestxt/rMovie00"+iv+".txt");}
        if (iv>=100000&&iv<=999999)
   {  linesr = loadStrings("rWtxt"+ordner+"/rSavestxt/rMovie0"+iv+".txt");}
        if (iv>=1000000&&iv<=9999999)
   {  linesr = loadStrings("rWtxt"+ordner+"/rSavestxt/rMovie"+iv+".txt");}
      
      
            if (iv>=1&&iv<=9)
    {  linesg = loadStrings("gWtxt"+ordner+"/gSavestxt/gMovie000000"+iv+".txt");}
        if (iv>=10&&iv<=99)
 {  linesg = loadStrings("gWtxt"+ordner+"/gSavestxt/gMovie00000"+iv+".txt");}
        if (iv>=100&&iv<=999)
 {  linesg = loadStrings("gWtxt"+ordner+"/gSavestxt/gMovie0000"+iv+".txt");}
        if (iv>=1000&&iv<=9999)
 {  linesg = loadStrings("gWtxt"+ordner+"/gSavestxt/gMovie000"+iv+".txt");}
        if (iv>=10000&&iv<=99999)
   {  linesg = loadStrings("gWtxt"+ordner+"/gSavestxt/gMovie00"+iv+".txt");}
        if (iv>=100000&&iv<=999999)
 {  linesg = loadStrings("gWtxt"+ordner+"/gSavestxt/gMovie0"+iv+".txt");}
        if (iv>=1000000&&iv<=9999999)
 {  linesg = loadStrings("gWtxt"+ordner+"/gSavestxt/gMovie"+iv+".txt");}
      
      
      
            if (iv>=1&&iv<=9)
        {  linesb = loadStrings("bWtxt"+ordner+"/bSavestxt/bMovie000000"+iv+".txt");}
            if (iv>=10&&iv<=99)
        {  linesb = loadStrings("bWtxt"+ordner+"/bSavestxt/bMovie00000"+iv+".txt");}
        if (iv>=100&&iv<=999)
          {  linesb = loadStrings("bWtxt"+ordner+"/bSavestxt/bMovie0000"+iv+".txt");}
        if (iv>=1000&&iv<=9999)
     {  linesb = loadStrings("bWtxt"+ordner+"/bSavestxt/bMovie000"+iv+".txt");}
        if (iv>=10000&&iv<=99999)
          {  linesb = loadStrings("bWtxt"+ordner+"/bSavestxt/bMovie00"+iv+".txt");}
        if (iv>=100000&&iv<=999999)
      {  linesb = loadStrings("bWtxt"+ordner+"/bSavestxt/bMovie0"+iv+".txt");}
        if (iv>=1000000&&iv<=9999999)
     {  linesb = loadStrings("bWtxt"+ordner+"/bSavestxt/bMovie"+iv+".txt");}
      
      
      
          if (iv>=1&&iv<=9)
              {  linesbw = loadStrings("bwWtxt"+ordner+"/bwSavestxt/bwMovie000000"+iv+".txt");}
   if (iv>=10&&iv<=99)
            {  linesbw = loadStrings("bwWtxt"+ordner+"/bwSavestxt/bwMovie00000"+iv+".txt");}
        if (iv>=100&&iv<=999)
                   {  linesbw = loadStrings("bwWtxt"+ordner+"/bwSavestxt/bwMovie0000"+iv+".txt");}
        if (iv>=1000&&iv<=9999)
            {  linesbw = loadStrings("bwWtxt"+ordner+"/bwSavestxt/bwMovie000"+iv+".txt");}
        if (iv>=10000&&iv<=99999)
              {  linesbw = loadStrings("bwWtxt"+ordner+"/bwSavestxt/bwMovie00"+iv+".txt");}
        if (iv>=100000&&iv<=999999)
              {  linesbw = loadStrings("bwWtxt"+ordner+"/bwSavestxt/bwMovie0"+iv+".txt");}
        if (iv>=1000000&&iv<=9999999)
            {  linesbw = loadStrings("bwWtxt"+ordner+"/bwSavestxt/bwMovie"+iv+".txt");}

     
     done=0;
   println("there" + linesbw.length + " lines");
lx1=1;
ly1=0;
li1=0;
while (done!=1){
...
//if (bild == null) { iv--; if (iv<0)iv=0;}
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Smily_Helpe2r_V_0_2_4_3" };
    if (passedArgs != null) {
