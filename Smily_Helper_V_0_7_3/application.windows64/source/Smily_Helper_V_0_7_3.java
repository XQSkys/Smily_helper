...
public class Smily_Helper_V_0_7_3 extends PApplet {
   ...
   while(sumly<num+1){ 
     if(sumlx<=num)
     {
       ...
       stroke(0);
         ...
         if((mouseoverx>=0&&mouseoverx<=feld*(num1+1))&&(mouseovery>=30&&mouseovery<=feld*(num1+1))){
   if   (mousePressed && (mouseButton == RIGHT)){
...
iv++;
 ...
 bild = loadImage("SavesMovie/Movie"+iv+".png");
       ...
       if (bild != null) {
          image(bild, 600, 630,num1+1,num1+1);
          image(bild,0,30, feld*(num1+1),feld*(num1+1));
         // saveFrame("bild.png");
 ...
 bildg = loadImage("gSavesMovie/gMovie"+iv+".png");
       ...
       if (bildg != null) {
          image(bildg, 800, 30,num1+1,num1+1);
          //image(bild,0,30, 600, 800);
         // saveFrame("bild.png");
 ...
 bildb = loadImage("bSavesMovie/bMovie"+iv+".png");
       ...
       if (bildb != null) {
          image(bildb, 600, 230,num1+1,num1+1);
          //image(bild,0,30, 600, 800);
         // saveFrame("bild.png");
 ...
 bildbw = loadImage("bwSavesMovie/bwMovie"+iv+".png");
       ...
       if (bildbw != null) {
          image(bildbw, 800, 230,num1+1,num1+1);
          //image(bild,0,30, 600, 800);
         // saveFrame("bild.png");
...
stroke(0);
    if   (mousePressed && (mouseButton == LEFT)){noStroke();fill(255);   rect(0,30,feld*(num1+1),feld*(num1+1));fill(255);  rect(600,30,num1+1,num1+1); fill(255); 
  rect(800,30,num1+1,num1+1);fill(255);  rect(600,230,num1+1,num1+1);fill(255);  rect(800,230,num1+1,num1+1); fill(255);  rect(600,630,num1+1,num1+1);}
     
   
 
   
    
  if   (mousePressed && (mouseButton == RIGHT)){noStroke();fill(rc,gc,bc);    rect(0,30,feld*(num1+1),feld*(num1+1));
fill(rc,0,0);  rect(600,30,num1+1,num1+1); fill(0,gc,0);  
rect(800,30,num1+1,num1+1);
fill(0,0,bc);  rect(600,230,num1+1,num1+1);qc=(rc+gc+bc)/3; fill(qc); rect(800,230,num1+1,num1+1); fill(rc,gc,bc);rect(600,630,num1+1,num1+1); }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Smily_Helper_V_0_7_3" };
    if (passedArgs != null) {
