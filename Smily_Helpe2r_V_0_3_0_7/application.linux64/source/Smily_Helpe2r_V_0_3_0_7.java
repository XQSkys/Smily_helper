...
public class Smily_Helpe2r_V_0_3_0_7 extends PApplet {
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        if (iv>=1&&iv<=9)
          bild.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie000000"+iv+".png");
        if (iv>=10&&iv<=99)
          bild.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie00000"+iv+".png");
        if (iv>=100&&iv<=999)
          bild.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie0000"+iv+".png");
        if (iv>=1000&&iv<=9999)
          bild.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie000"+iv+".png");
        if (iv>=10000&&iv<=99999)
          bild.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie00"+iv+".png");
        if (iv>=100000&&iv<=999999)
          bild.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie0"+iv+".png");
        if (iv>=1000000&&iv<=9999999)
          bild.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie"+iv+".png");
        bild.save("Film_Ordner_png_"+ordner+"/work/bild.png");
...
outputbbw.println(grayValue); 
 ...
 neu=0;
      ...
      if (bildr != null) {
        ...
        if (iv>=1&&iv<=9)
          bildr.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie000000"+iv+".png");
        if (iv>=10&&iv<=99)
          bildr.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie00000"+iv+".png");
        if (iv>=100&&iv<=999)
          bildr.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie0000"+iv+".png");
        if (iv>=1000&&iv<=9999)
          bildr.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie000"+iv+".png");
        if (iv>=10000&&iv<=99999)
          bildr.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie00"+iv+".png");
        if (iv>=100000&&iv<=999999)
          bildr.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie0"+iv+".png");
        if (iv>=1000000&&iv<=9999999)
          bildr.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie"+iv+".png");
      ...
      if (bildg != null) {
        ...
        if (iv>=1&&iv<=9)
          bildg.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie000000"+iv+".png");
        if (iv>=10&&iv<=99)
          bildg.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie00000"+iv+".png");
        if (iv>=100&&iv<=999)
          bildg.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie0000"+iv+".png");
        if (iv>=1000&&iv<=9999)
          bildg.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie000"+iv+".png");
        if (iv>=10000&&iv<=99999)
          bildg.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie00"+iv+".png");
        if (iv>=100000&&iv<=999999)
          bildg.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie0"+iv+".png");
        if (iv>=1000000&&iv<=9999999)
          bildg.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie"+iv+".png");
      ...
      if (bildb != null) {
        ...
        if (iv>=1&&iv<=9)
          bildb.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie000000"+iv+".png");
        if (iv>=10&&iv<=99)
          bildb.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie00000"+iv+".png");
        if (iv>=100&&iv<=999)
          bildb.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie0000"+iv+".png");
        if (iv>=1000&&iv<=9999)
          bildb.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie000"+iv+".png");
        if (iv>=10000&&iv<=99999)
          bildb.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie00"+iv+".png");
        if (iv>=100000&&iv<=999999)
          bildb.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie0"+iv+".png");
        if (iv>=1000000&&iv<=9999999)
          bildb.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie"+iv+".png");
      ...
      if (bildbw != null) {
        ...
        if (iv>=1&&iv<=9)
          bildbw.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie000000"+iv+".png");
        if (iv>=10&&iv<=99)
          bildbw.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie00000"+iv+".png");
        if (iv>=100&&iv<=999)
          bildbw.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie0000"+iv+".png");
        if (iv>=1000&&iv<=9999)
          bildbw.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie000"+iv+".png");
        if (iv>=10000&&iv<=99999)
          bildbw.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie00"+iv+".png");
        if (iv>=100000&&iv<=999999)
          bildbw.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie0"+iv+".png");
        if (iv>=1000000&&iv<=9999999)
          bildbw.save("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie"+iv+".png");
 ...
 println("yess");
  ...
  li++;
    ...
    */
    ...
    if (iv>=1&&iv<=9)
      bild = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie000000"+iv+".png");
    if (iv>=10&&iv<=99)
      bild = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie00000"+iv+".png");
    if (iv>=100&&iv<=999)
      bild = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie0000"+iv+".png");
    if (iv>=1000&&iv<=9999)
      bild = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie000"+iv+".png");
    if (iv>=10000&&iv<=99999)
      bild = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie00"+iv+".png");
    if (iv>=100000&&iv<=999999)
      bild = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie0"+iv+".png");
    if (iv>=1000000&&iv<=9999999)
      bild = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/SavesMovie/Movie"+iv+".png");
...
//if (bild == null) { iv--; if (iv<0)iv=0;}
  ...
  noStroke();
   ...
   // bildr = loadImage("work"+ordner+"/rSavesMovie/rMovie000000"+iv+".png");
    ...
    if (iv>=1&&iv<=9)
      bildr = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie000000"+iv+".png");
    if (iv>=10&&iv<=99)
      bildr = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie00000"+iv+".png");
    if (iv>=100&&iv<=999)
      bildr = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie0000"+iv+".png");
    if (iv>=1000&&iv<=9999)
      bildr = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie000"+iv+".png");
    if (iv>=10000&&iv<=99999)
      bildr = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie00"+iv+".png");
    if (iv>=100000&&iv<=999999)
      bildr = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie0"+iv+".png");
    if (iv>=1000000&&iv<=9999999)
      bildr = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/rSavesMovie/rMovie"+iv+".png");
    ...
    if (bildr != null) {
      ...
      // saveFrame("Film_Ordner_png_"+ordner+"/work"+ordner+"/bild.png");
  ...
  //  bildg = loadImage("work"+ordner+"/gSavesMovie/gMovie000000"+iv+".png");
    ...
    if (iv>=1&&iv<=9)
      bildg = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie000000"+iv+".png");
    if (iv>=10&&iv<=99)
      bildg = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie00000"+iv+".png");
    if (iv>=100&&iv<=999)
      bildg = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie0000"+iv+".png");
    if (iv>=1000&&iv<=9999)
      bildg = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie000"+iv+".png");
    if (iv>=10000&&iv<=99999)
      bildg = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie00"+iv+".png");
    if (iv>=100000&&iv<=999999)
      bildg = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie0"+iv+".png");
    if (iv>=1000000&&iv<=9999999)
      bildg = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/gSavesMovie/gMovie"+iv+".png");
    ...
    if (iv>=1&&iv<=9)
      bildb = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie000000"+iv+".png");
    if (iv>=10&&iv<=99)
      bildb = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie00000"+iv+".png");
    if (iv>=100&&iv<=999)
      bildb = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie0000"+iv+".png");
    if (iv>=1000&&iv<=9999)
      bildb = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie000"+iv+".png");
    if (iv>=10000&&iv<=99999)
      bildb = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie00"+iv+".png");
    if (iv>=100000&&iv<=999999)
      bildb = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie0"+iv+".png");
    if (iv>=1000000&&iv<=9999999)
      bildb = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bSavesMovie/bMovie"+iv+".png");
  ...
  //  bildbw = loadImage("work"+ordner+"/bwSavesMovie/bwMovie000000"+iv+".png");
    ...
    if (iv>=1&&iv<=9)
      bildbw = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie000000"+iv+".png");
    if (iv>=10&&iv<=99)
      bildbw = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie00000"+iv+".png");
    if (iv>=100&&iv<=999)
      bildbw = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie0000"+iv+".png");
    if (iv>=1000&&iv<=9999)
      bildbw = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie000"+iv+".png");
    if (iv>=10000&&iv<=99999)
      bildbw = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie00"+iv+".png");
    if (iv>=100000&&iv<=999999)
      bildbw = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie0"+iv+".png");
    if (iv>=1000000&&iv<=9999999)
      bildbw = loadImage("Film_Ordner_png_"+ordner+"/work"+ordner+"/bwSavesMovie/bwMovie"+iv+".png");
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Smily_Helpe2r_V_0_3_0_7" };
    if (passedArgs != null) {
