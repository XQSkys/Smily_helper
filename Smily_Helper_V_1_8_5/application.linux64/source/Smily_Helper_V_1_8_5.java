...
public class Smily_Helper_V_1_8_5 extends PApplet {
...
String[] linesbw = loadStrings("list.txt");
...
//if (bild == null) { iv--; if (iv<0)iv=0;}
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Smily_Helper_V_1_8_5" };
    if (passedArgs != null) {
