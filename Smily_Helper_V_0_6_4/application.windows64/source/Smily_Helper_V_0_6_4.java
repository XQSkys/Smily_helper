...
public class Smily_Helper_V_0_6_4 extends PApplet {
...
stroke(0);
    if   (mousePressed && (mouseButton == LEFT)){fill(255);   rect(0,30,feld*(num1+1),feld*(num1+1));fill(255);  rect(600,30,200,200); fill(255); 
  rect(800,30,200,200);fill(255);  rect(600,230,200,200);fill(255);  rect(800,230,200,200); fill(255);  rect(600,630,200,200);}
     
   
 
   
    
  if   (mousePressed && (mouseButton == RIGHT)){stroke(0);fill(rc,gc,bc);    rect(0,30,feld*(num1+1),feld*(num1+1));
fill(rc,0,0);  rect(600,30,200,200); fill(0,gc,0);  
rect(800,30,200,200);
fill(0,0,bc);  rect(600,230,200,200);fill(qc); rect(800,230,200,200); rect(600,630,200,200); }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Smily_Helper_V_0_6_4" };
    if (passedArgs != null) {
