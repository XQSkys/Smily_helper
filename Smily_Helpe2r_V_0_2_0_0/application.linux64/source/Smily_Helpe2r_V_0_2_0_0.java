...
public class Smily_Helpe2r_V_0_2_0_0 extends PApplet {
    ...
    //----------------------------------------------------------------------------------------------------------
      if (iv>=0&&iv<=9)
        ...
        if (iv>=100000&&iv<=999999)
           outputbw = createWriter("bwWtxt"+ordner+"/bwSavestxt/bwMovie000000"+iv+".txt");
        if (iv>=1000000&&iv<=9999999)
         outputbw = createWriter("bwWtxt"+ordner+"/bSavestxt/bwMovie000000"+iv+".txt");
...
li=0;
  ...
  String fff="eof";
     ...
     // String[] linesr = loadStrings("");
            String[] linesr=loadStrings(""); ;
String[] linesg =loadStrings("");
String[] linesb =loadStrings("");;
String[] linesbw =loadStrings("");;
...
//if (bild == null) { iv--; if (iv<0)iv=0;}
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Smily_Helpe2r_V_0_2_0_0" };
    if (passedArgs != null) {
